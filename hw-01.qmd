...
---
```{r}
#|label: install packages for exercises
...
yearnhood %>%
  ...
  geom_tile(aes(fill=nhood))+
  scale_fill_discrete(name="Neighborhood") +
  labs(title = "Rental prices per bedroom across different neighborhoods in San Francisco",
        x = "Bedrooms",
        y = "Price")
        
#I chose to use a Geom Tile since we are using three variables which is price, bedrooms, and neigbhorhood. According to lecture, this is one method that would be effective in illustrating 3 variables. However, I am having difficulty in displaying it correctly, the tiles are somewhat in a line shape and I might need guidance in fixing this. 
